...
public class Secram2BamFile {
	public static void main(String[] args) throws Exception {
		// String bam =
		// "./data/HG00115.chrom11.ILLUMINA.bwa.GBR.exome.20130415.bam",
		// secram =
		// "./data/HG00115.chrom11.ILLUMINA.bwa.GBR.exome.20130415.secram",
		// newBam =
		// "./data/HG00115.chrom11.ILLUMINA.bwa.GBR.exome.20130415.secram.bam",
		// ref = "./data/hs37d5.fa";
		byte[] key = "SECRET_1SECRET_2SECRET_3".getBytes();
		String ref = args[0], secram = args[1], bam = args[2];

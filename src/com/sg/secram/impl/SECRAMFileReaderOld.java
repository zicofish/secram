...
public class SECRAMFileReaderOld implements Iterable<SecramRecordOld>{
	...
	public SECRAMFileReaderOld(String input) throws IOException{
		this(input, "./data/hs37d5.fa");
	}
	
	public SECRAMFileReaderOld(String input, String referenceInput) throws IOException {
		this(input, referenceInput, new SECRAMSecurityFilter());
	}
	
	public SECRAMFileReaderOld(String input, String referenceInput, SECRAMSecurityFilter filter) throws IOException{
	...
	private class RecordIterator implements Iterator<SecramRecordOld> {
		...
		public SecramRecordOld next() {
			...
			try {
				...
				record =  new SecramRecordOld(avroRecord, getReferenceBase(pos));
	...
	public Iterator<SecramRecordOld> iterator() {
		try {
			...
			return new Iterator<SecramRecordOld>() {
				@Override
				public boolean hasNext() { return false; }

				@Override
				public SecramRecordOld next() throws NoSuchElementException { throw new NoSuchElementException(); }
			};
		}

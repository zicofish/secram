...
public enum SecramEncodingKey {
	AP_AbsolutePosition, NH_NumberOfReadHeaders, RL_ReferenceLength, MQ_MappingQualityScore, RN_ReadName, FG_Flag, TL_TemplateLength, NP_NextAbsolutePosition, TG_tags, SF_SensitiveField, CV_Coverage, NF_NumberOfFeatures, FO_FeatureOrder, FC_FeatureCode, FL_FeatureLength, FB_FeatureBase, QS_QualityScore, QL_QualityScoreLength;

...
public class BaseHalfByteMap {
	...
	public static byte[] halfByte2BaseArray = new byte[]{
		(byte)'=', (byte)'A', (byte)'C', (byte)'M', 
		(byte)'G', (byte)'R', (byte)'S', (byte)'V', 
		(byte)'T', (byte)'W', (byte)'Y', (byte)'H', 
		(byte)'K', (byte)'D', (byte)'B', (byte)'N'
	};

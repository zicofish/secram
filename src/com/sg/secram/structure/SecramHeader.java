...
/**
 * A starting object when dealing with SECRAM files. A {@link SecramHeader} holds 3 things: 
 * 1. File format definition, including content id
 * 2. A 64-bit random salt for order-preserving encryption
 * 3. SAM file header
 */
public final class SecramHeader {
    ...
    /**
     * Create a new {@link SecramHeader} object with id and SAM file header.
     ...
     */
    public SecramHeader(final String id, final SAMFileHeader samFileHeader, final long opeSalt) {
     ...
     * @return true if ids and SAM file header are exactly the same, false otherwise
     */
    @Override
    public boolean equals(final Object obj) {
        if (obj == null) return false;
        if (!(obj instanceof SecramHeader)) return false;
    ...
    /**
     * Get the {@link SAMFileHeader} object associated with this SECRAM file header.

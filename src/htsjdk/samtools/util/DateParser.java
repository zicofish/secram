...
/**
 * NOTE: This code has been taken from w3.org, and modified slightly to handle
 * timezones of the form [-+]DDDD, and also to fix a bug in the application of
 * time zone to the parsed date.
 *
		...
		try {
			...
			if (!tok.equals("Z")) { // UTC
				...
				if (check(st, ":") && (st.hasMoreTokens())) {
					...
					// Modified by AW -- minute field is not required, and
					// minutes may be represented

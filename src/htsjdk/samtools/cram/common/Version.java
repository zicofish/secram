...
/**
 * A class to represent a version information, 3 number: major, minor and build
 * number.
 */
public class Version implements Comparable<Version> {
	 ...
	 * @param o
	 *            another version
	 * @return 0 if both versions are the same, a negative if the other version
	 *         is higher and a positive otherwise.
	 */
	@Override

...
/**
 * Encoding ID as defined in the CRAM specs. These are basically ways to
 * serialize a data series.
 */
public enum EncodingID {
	/**
	 * "Do nothing" encoding. Should throw an exception when trying reading or
	 * writing with this encoding.
	 */
	NULL,
	/**
	 * Shove the data into a byte array for compressing later with a generic
	 * compressor like GZIP.
	 */
	EXTERNAL,
	/**

...
/**
 * A starting object when dealing with CRAM files. A {@link CramHeader} holds 2
 * things: 1. File format definition, including content id and version
 * information 2. SAM file header
 */
public final class CramHeader {
	...
	/**
	 * Create a new {@link CramHeader} object with the specified version, id and
	 * SAM file header. The id field by default is guaranteed to be byte[20].
	 *
	 * @param version
	 ...
	 * @return true if versions, ids and SAM file header are exactly the same,
	 *         false otherwise
	 */
	@Override
	public boolean equals(final Object obj) {
		...
		if (getVersion().major != header.getVersion().major)
			return false;
		// noinspection SimplifiableIfStatement
		if (getVersion().minor != header.getVersion().minor)
			return false;
	...
	/**
	 * Get the {@link SAMFileHeader} object associated with this CRAM file
	 * header.
	 * 

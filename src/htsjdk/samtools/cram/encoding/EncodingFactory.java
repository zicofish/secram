 ...
 * {@link htsjdk.samtools.cram.encoding.Encoding} for a given
 * {@link htsjdk.samtools.cram.encoding.DataSeriesType} and
 * {@link htsjdk.samtools.cram.encoding.Encoding}. Also useful to hide encoding
 * implementations.
 */
...
public class EncodingFactory {
	 ...
	 * 
	 * @param valueType
	 *            data type of the values to be produced/consumed by the
	 *            encoding
	 * @param id
	 *            encoding id used for data serialization
	 * @param <T>
	 *            encoding object type, like Integer or String.

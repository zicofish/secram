...
public class RANS {
	...
	public static ByteBuffer compress(final ByteBuffer in, final ORDER order,
	...
	private static void finalizeCompressed(final int order,
			final ByteBuffer out_buf, final int in_size,
			final int frequencyTable_size, final int compressedBlob_size) {

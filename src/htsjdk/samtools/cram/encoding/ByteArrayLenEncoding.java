...
public class ByteArrayLenEncoding implements Encoding<byte[]> {
	...
	public void fromByteArray(final byte[] data) {
		...
		byteEncoding = encodingFactory.createEncoding(
				DataSeriesType.BYTE_ARRAY, byteID);

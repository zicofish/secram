...
/**
 * An index interface with additional functionality for querying and inspecting
 * the structure of a BAM index.
 *
 * @author mhanna
 * @version 0.1
 */
public interface BrowseableBAMIndex extends BAMIndex {
	 ...
	 * 
	 * @param levelNumber
	 *            Level for which to inspect the size.
	 ...
	 */
	BinList getBinsOverlapping(final int referenceIndex, final int startPos,
			final int endPos);

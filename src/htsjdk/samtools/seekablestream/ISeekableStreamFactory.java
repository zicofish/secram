 ...
 * Implementations can be set as the default with
 * {@link SeekableStreamFactory#setInstance(ISeekableStreamFactory)}
 * 
 * @author jacob
 * @date 2013-Oct-24
 */
public interface ISeekableStreamFactory {
	...
	/**
	 * Return a buffered {@code SeekableStream} which wraps the input
	 * {@code stream} using the default buffer size
	 * 
	 * @param stream
	 * @return
	 */

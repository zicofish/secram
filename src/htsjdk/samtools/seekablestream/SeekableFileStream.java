...
public class SeekableFileStream extends SeekableStream {
	...
	/**
	 * Collection of all open instances. SeekableFileStream objects are usually
	 * open and kept open for the duration of a session. This collection
	 * supports a method to close them all.
	 */
	static Collection<SeekableFileStream> allInstances = Collections
			.synchronizedCollection(new HashSet<SeekableFileStream>());

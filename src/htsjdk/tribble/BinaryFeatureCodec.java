...
/**
 * Implements common methods of {@link FeatureCodec}s that read from
 * {@link htsjdk.tribble.readers.PositionalBufferedStream}s.
 * 
 * @author mccowan
 */
abstract public class BinaryFeatureCodec<T extends Feature> implements
